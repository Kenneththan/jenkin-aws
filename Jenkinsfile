pipeline {
    ...
    environment {
        ...
        TRIVY_HOME = '/usr/bin'
        REPO_URL = 'https://github.com/Kenneththan/jenkin-aws.git'
        REPO_BRANCH = 'main'
        DOCKER_IMAGE_NAME = 'thphyo/awsnetflix'
                    ...
                    script {
                        dir('Kubernetes') {
                            withKubeConfig(
                                ...
                                serverUrl: 'https://623E26DE8A245C3A944A8A0F336FA858.gr7.ap-southeast-1.eks.amazonaws.com', // Replace with actual EKS endpoint
